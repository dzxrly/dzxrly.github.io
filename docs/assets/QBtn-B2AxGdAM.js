...
import { v as de, d as fe, e as ve, Q as z, b as ge } from './QSpinner-BS31LsP8.js';
import { b as me } from './render-C8JR9mId.js';
function Q(e) {
...
function be(e, t) {
  for (const a in t) {
    ...
    if (typeof n == 'string') {
      if (n !== l) return !1;
    } else if (Array.isArray(l) === !1 || l.length !== n.length || n.some((m, f) => m !== l[f]))
      return !1;
  }
  return !0;
}
...
function he(e, t) {
  return Array.isArray(e) === !0 ? F(e, t) : Array.isArray(t) === !0 ? F(t, e) : e === t;
}
function ye(e, t) {
...
function ke({ fallbackTag: e, useDisableForRouterLinkProps: t = !0 } = {}) {
  const a = X(),
    ...
    S =
      t === !0
        ...
        : o(() => f === !0 && d.value !== !0 && n.to !== void 0 && n.to !== null && n.to !== ''),
    h = o(() => (S.value === !0 ? w(n.to) : null)),
    v = o(() => h.value !== null),
    x = o(() => d.value === !0 || v.value === !0),
    u = o(() => (n.type === 'a' || x.value === !0 ? 'a' : n.tag || e || 'div')),
    y = o(() =>
      d.value === !0
    ...
    g = o(() => {
      ...
      const { matched: s } = h.value,
        { length: p } = s,
        E = s[p - 1];
      if (E === void 0) return -1;
      const $ = l.$route.matched;
      if ($.length === 0) return -1;
      const R = $.findIndex(V.bind(null, E));
      if (R !== -1) return R;
      const K = Q(s[p - 2]);
      return p > 1 && Q(E) === K && $[$.length - 1].path !== K
        ? $.findIndex(V.bind(null, s[p - 2]))
        : R;
    }),
    k = o(() => v.value === !0 && g.value !== -1 && be(l.$route.params, h.value.params)),
    i = o(
      () =>
        k.value === !0 &&
        g.value === l.$route.matched.length - 1 &&
        ye(l.$route.params, h.value.params),
    ),
    b = o(() =>
      v.value === !0
        ? i.value === !0
  ...
  function B(s, { returnRouterError: p, to: E = n.to, replace: $ = n.replace } = {}) {
    ...
    s.preventDefault();
    const R = l.$router[$ === !0 ? 'replace' : 'push'](E);
    return p === !0 ? R : R.then(() => {}).catch(() => {});
  }
  function P(s) {
    if (v.value === !0) {
      const p = (E) => B(s, E);
      (m('click', s, p), s.defaultPrevented !== !0 && p());
    } else m('click', s);
  }
  return {
    hasRouterLink: v,
...
function H(e, t, a, n) {
  ...
  const f = document.createElement('span'),
    ...
    S = re(e),
    { left: h, top: v, width: x, height: u } = t.getBoundingClientRect(),
    y = Math.sqrt(x * x + u * u),
    g = y / 2,
    k = `${(x - y) / 2}px`,
    i = m ? k : `${S.left - h - g}px`,
  ...
  ((d.className = 'q-ripple__inner'),
    pe(d, {
      height: `${y}px`,
      width: `${y}px`,
      transform: `translate3d(${i},${w},0) scale3d(.2,.2,1)`,
      opacity: 0,
    }),
    ...
    t.appendChild(f));
  const B = () => {
    (f.remove(), clearTimeout(P));
  };
  a.abort.push(B);
  let P = setTimeout(() => {
    (d.classList.add('q-ripple__inner--enter'),
      (d.style.transform = `translate3d(${k},${b},0) scale3d(1,1,1)`),
      (d.style.opacity = 0.2),
      (P = setTimeout(() => {
        (d.classList.remove('q-ripple__inner--enter'),
          ...
          (d.style.opacity = 0),
          (P = setTimeout(() => {
            (f.remove(), a.abort.splice(a.abort.indexOf(B), 1));
          }, 275)));
      }, 250)));
  }, 50);
}
function U(e, { modifiers: t, value: a, arg: n }) {
...
const xe = te({
      ...
      const n = {
        ...
        start(l) {
          n.enabled === !0 &&
            ...
            H(l, e, n, l.qKeyEvent === !0);
        },
        keystart: qe((l) => {
          n.enabled === !0 &&
            l.qSkipRipple !== !0 &&
            D(l, n.modifiers.keyCodes) === !0 &&
    ...
    updated(e, t) {
      if (t.oldValue !== t.value) {
        ...
        a !== void 0 &&
          ((a.enabled = t.value !== !1),
          a.enabled === !0 && Object(t.value) === t.value && U(a, t));
      }
    },
    beforeUnmount(e) {
      const t = e.__qripple;
  ...
  Le = Object.keys(J),
  Ee = { align: { type: String, validator: (e) => Le.includes(e) } };
function Ce(e) {
  return o(() => {
...
const W = { none: 0, xs: 4, sm: 8, md: 16, lg: 24, xl: 32 },
  $e = { xs: 8, sm: 10, md: 14, lg: 20, xl: 24 },
  Se = ['button', 'submit', 'reset'],
  Re = /[^\s]\/[^\s]/,
  ...
  const t = ve(e, $e),
    ...
    y = o(() => {
      ...
      return (
        l.value === !0
          ...
          : Se.includes(e.type) === !0 && (i.type = e.type),
        m.value === 'a'
          ? (e.disable === !0
              ? (i['aria-disabled'] = 'true')
              : i.href === void 0 && (i.role = 'button'),
            n.value !== !0 && Re.test(e.type) === !0 && (i.type = e.type))
          : e.disable === !0 && ((i.disabled = ''), (i['aria-disabled'] = 'true')),
        e.loading === !0 &&
          e.percentage !== void 0 &&
          Object.assign(i, {
            role: 'progressbar',
    ...
    g = o(() => {
      ...
      const b =
        e.round === !0
          ? 'round'
          : `rectangle${h.value === !0 ? ' q-btn--rounded' : e.square === !0 ? ' q-btn--square' : ''}`;
      return (
...
const { passiveCapture: q } = le;
let A = null,
  _ = null,
  O = null;
const De = ue({
  name: 'QBtn',
  props: { ...we, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] },
  ...
  setup(e, { slots: t, emit: a }) {
    ...
    const b = o(() => e.label !== void 0 && e.label !== null && e.label !== ''),
      w = o(() =>
        e.disable === !0 || e.ripple === !1
          ? !1
          : { keyCodes: S.value === !0 ? [13, 32] : [13], ...(e.ripple === !0 ? {} : e.ripple) },
      ),
      B = o(() => ({ center: e.round })),
      P = o(() => {
      ...
      s = o(() => {
        if (e.loading === !0)
          return { onMousedown: j, onTouchstart: j, onClick: j, onKeydown: j, onKeyup: j };
        if (x.value === !0) {
          const r = { onClick: E, onKeydown: $, onMousedown: K };
      ...
      if (u.value !== null) {
        if (r !== void 0) {
          ...
          if (
            ...
            r.qAvoidFocus !== !0 && u.value.focus();
            const I = () => {
              (document.removeEventListener('keydown', T, !0),
                document.removeEventListener('keyup', I, q),
                u.value?.removeEventListener('blur', I, q));
            };
            (document.addEventListener('keydown', T, !0),
              document.addEventListener('keyup', I, q),
              u.value.addEventListener('blur', I, q));
          }
        }
        v(r);
      }
      ...
      u.value !== null &&
        ...
        D(r, [13, 32]) === !0 &&
          ...
          r.defaultPrevented !== !0 &&
            ...
            u.value.addEventListener('blur', C, q)),
          T(r)));
    }
    function R(r) {
      u.value !== null &&
        ...
        r.defaultPrevented !== !0 &&
          (A !== u.value &&
            ...
            (A = u.value),
            (g = r.target),
            g.addEventListener('touchcancel', C, q),
            g.addEventListener('touchend', C, q)),
          (k = !0),
    ...
    function C(r) {
      if (u.value !== null && !(r?.type === 'blur' && document.activeElement === u.value)) {
        if (r?.type === 'keyup') {
          if (_ === u.value && D(r, [13, 32]) === !0) {
            const c = new MouseEvent('click', r);
            ((c.qKeyEvent = !0),
              r.defaultPrevented === !0 && ie(c),
              r.cancelBubble === !0 && Y(c),
    ...
    function M(r) {
      ...
      (r !== !0 &&
        ...
        A === u.value &&
          (g !== null &&
            (g.removeEventListener('touchcancel', C, q), g.removeEventListener('touchend', C, q)),
          (A = g = null)),
        O === u.value && (document.removeEventListener('mouseup', C, q), (O = null)),
        _ === u.value &&
          (document.removeEventListener('keyup', C, !0),
          u.value?.removeEventListener('blur', C, q),
          (_ = null)),
    ...
    return (
      ...
      () => {
        let r = [];
        (e.icon !== void 0 &&
          r.push(L(z, { name: e.icon, left: e.stack !== !0 && b.value === !0, role: 'img' })),
          b.value === !0 && r.push(L('span', { class: 'block' }, [e.label])),
          (r = me(t.default, r)),
          e.iconRight !== void 0 &&
            e.round === !1 &&
            r.push(
              L(z, { name: e.iconRight, right: e.stack !== !0 && b.value === !0, role: 'img' }),
            ));
        const c = [L('span', { class: 'q-focus-helper', ref: y })];
        return (
          e.loading === !0 &&
            e.percentage !== void 0 &&
            c.push(
              L(
                ...
                [L('span', { class: 'q-btn__progress-indicator fit block', style: P.value })],
              ),
            ),
          c.push(
            L(
          ...
          e.loading !== null &&
            c.push(
              L(se, { name: 'q-transition--fade' }, () =>
                e.loading === !0
                  ? [
                      L(
                        'span',
                        { key: 'loading', class: 'absolute-full flex flex-center' },
                        t.loading !== void 0 ? t.loading() : [L(ge)],
                      ),
                    ]
                  : null,
              ),
            ),
          ce(L(h.value, p.value, c), [[xe, w.value, void 0, B.value]])
        );
      }
    );
  },
