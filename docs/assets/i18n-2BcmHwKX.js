import { d as h } from './index-DWv1t-r6.js';
import { c as r } from './vue-i18n.runtime-cGvmvPYv.js';
const i = {
  ...
  P = (o) => {
    if (!o) return n;
    const e = p[o];
    return e || (Object.hasOwn(a, o) ? o : n);
  },
  c = h(({ app: o }) => {
    const e = typeof navigator < 'u' ? navigator.language : void 0,
      t = P(e),
      s = r({ locale: t, globalInjection: !0, fallbackLocale: n, messages: a });
    o.use(s);
  });
export { c as default };
