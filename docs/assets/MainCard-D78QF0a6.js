...
import { C as t } from './CardButton-FKL5xI0_.js';
...
const b = { class: 'main-card-wrapper full-width' },
  k = d({
    __name: 'MainCard',
    setup(x) {
      f((o) => ({ '3f45d87b': u.value, '77327ed7': v.value }));
      const n = B(),
        c = s(m('isShiny') || !1),
        e = s({ coefficientA: 0.015, coefficientB: 0.021, valueMax: 12, valueMin: 9 }),
        l = s(4),
        i = a(() => {
          const o = n.screen.width * e.value.coefficientA + e.value.coefficientB;
          return o > e.value.valueMax
            ? e.value.valueMax
            : o < e.value.valueMin
              ? e.value.valueMin
              : o;
        }),
        p = a(() => (c.value ? '643s.gif' : '643.gif')),
        u = a(() => `${i.value}rem`),
        v = a(() => {
          const o = Math.floor(n.screen.width / 16 / i.value);
          return o > l.value ? l.value : o;
        });
      return (o, y) => (
        h(),
        _('div', b, [
  ...
  T = g(k, [['__scopeId', 'data-v-78bf9c65']]);
export { T as default };
