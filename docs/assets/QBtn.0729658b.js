...
function ke({ fallbackTag: e, useDisableForRouterLinkProps: t = !0 } = {}) {
  const a = Y(),
    ...
    y = s(() => (C.value === !0 ? B(n.to) : null)),
    v = s(() => y.value !== null),
    $ = s(() => d.value === !0 || v.value === !0),
    u = s(() => (n.type === 'a' || $.value === !0 ? 'a' : n.tag || e || 'div')),
    k = s(() =>
      d.value === !0
  ...
  function w(
    ...
    if (n.disable === !0) return o.preventDefault(), Promise.resolve(!1);
    if (
      o.metaKey ||
      o.altKey ||
      o.ctrlKey ||
  ...
  function R(o) {
    if (v.value === !0) {
      const q = (S) => w(o, S);
      m('click', o, q), o.defaultPrevented !== !0 && q();
    } else m('click', o);
  }
  return {
    hasRouterLink: v,
...
function qe(e) {
  return {
    cSize: s(() => (e.size in N ? `${N[e.size]}px` : e.size)),
...
function Oe(e) {
  const t = ve(e, we),
    ...
    y = s(() => e.rounded === !0 || e.fab === !0 || e.fabMini === !0),
    v = s(() => e.disable !== !0 && e.loading !== !0),
    $ = s(() => (v.value === !0 ? e.tabindex || 0 : -1)),
    u = s(() => te(e, 'standard')),
    k = s(() => {
...
var Ve = Z({
  ...
  setup(e, { slots: t, emit: a }) {
    ...
    let g = null,
      p,
      i = null;
    const b = s(() => e.label !== void 0 && e.label !== null && e.label !== ''),
      B = s(() =>
    ...
    return (
      ...
      () => {
        ...
        return (
          ...
          oe(h(y.value, q.value, c), [[Ee, B.value, void 0, w.value]])
        );
      }
    );
  },
