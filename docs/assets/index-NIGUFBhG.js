...
const { toString: Ze } = Object.prototype,
  ...
  { iterator: X, toStringTag: Ne } = Symbol,
  G = ((e) => (t) => {
    const n = Ze.call(t);
...
const et = Q('string'),
  ...
  [ut, ft, dt, pt] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(C),
  ...
  Be = ((e, t) =>
    e
      ...
      : t
        ...
        : (n) => setTimeout(n))(typeof setImmediate == 'function', A(U.postMessage)),
  Dt =
...
function Z(e, t, n) {
        ...
        return (
          ...
          w.forEach(function (g, P) {
            !(a.isUndefined(g) || g === null) &&
              t.append(i === !0 ? me([y], P, o) : i === null ? y : y + '[]', l(g));
          }),
          !1
        );
    }
  ...
  const d = [],
    b = Object.assign(Ht, { defaultVisitor: u, convertValue: l, isVisitable: oe });
  function R(p, y) {
    if (!a.isUndefined(p)) {
      ...
      (d.push(p),
        a.forEach(p, function (w, S) {
          (!(a.isUndefined(w) || w === null) &&
            s.call(t, w, a.isString(S) ? S.trim() : S, y, b)) === !0 && R(w, y ? y.concat(S) : [S]);
        }),
        d.pop());
    }
  }
...
const Ie = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 },
  ...
  Vt = de && (!ie || ['ReactNative', 'NativeScript', 'NS'].indexOf(ie.product) < 0),
  Wt =
    ...
    function (t, n) {
      ...
      if (o) {
        ...
        if ((c = a.isFileList(t)) || r.indexOf('multipart/form-data') > -1) {
          ...
          return Z(c ? { 'files[]': t } : t, f && new f(), this.formSerializer);
        }
      }
...
const Ve = (e) => {
    ...
    ((t.headers = i = x.from(i)),
      (t.url = He(Je(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer)),
      c &&
        i.set(
          'Authorization',
          'Basic ' +
  ...
  hn =
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        function w() {
          if (!h) return;
          const g = x.from('getAllResponseHeaders' in h && h.getAllResponseHeaders()),
            T = {
        ...
        ('onloadend' in h
          ...
          (h.ontimeout = function () {
            ...
            (s.timeoutErrorMessage && (P = s.timeoutErrorMessage),
              r(new m(P, T.clarifyTimeoutError ? m.ETIMEDOUT : m.ECONNABORTED, e, h)),
              (h = null));
          }),
          ...
          l && (([b, p] = K(l, !0)), h.addEventListener('progress', b)),
          f &&
            h.upload &&
            (([d, R] = K(f)),
...
const Sn = async (e) => {
    ...
    if ((a.isURLSearchParams(e) && (e = e + ''), a.isString(e))) return (await En(e)).byteLength;
  },
  gn = async (e, t) => {
      ...
      try {
        if (f && Rn && n !== 'get' && n !== 'head' && (h = await gn(u, r)) !== 0) {
          let T = new Request(t, { method: 'POST', body: r, duplex: 'half' }),
            F;
          if (
            (a.isFormData(r) && (F = T.headers.get('content-type')) && u.setContentType(F), T.body)
          ) {
            const [_, $] = Ee(h, K(Re(f)));
            r = ge(T.body, Oe, _, $);
          }
        ...
        throw (
          ...
          w && w.name === 'TypeError' && /Load failed|fetch/i.test(w.message)
            ? Object.assign(new m('Network Error', m.ERR_NETWORK, e, p), { cause: w.cause || w })
...
let L = class {
  constructor(t) {
    ((this.defaults = t || {}), (this.interceptors = { request: new be(), response: new be() }));
  }
  async request(t, n) {
    try {
    ...
    (r !== void 0 &&
      ...
      s != null &&
        (a.isFunction(s)
          ...
          : W.assertOptions(s, { encode: N.function, serialize: N.function }, !0)),
