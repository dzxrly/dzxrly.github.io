...
<template>
  <detail-page-wrapper>
    <div
      ...
      class="justify-center items-center full-width"
    >
      <div
        :class="isLtSm ? 'col justify-center' : 'col-4 justify-end'"
      ...
      <div
        :class="
          isLtSm ? 'col justify-center q-pt-xl' : 'col-8 justify-start q-pl-xl'
        "
        class="row items-center"
      >
        <div
        ...
        >
          ...
          >
            <div
              v-for="langBadge in languageBadgeUrl"
              :key="langBadge"
              class="q-mr-sm"
            >
