<template>
  <div id="cf-wrapper full-width">
    <div id="cf-error-details" class="p-0">
      <header class="mx-auto pt-10 lg:pt-6 lg:px-8 w-240 lg:w-full mb-8">
        <h1
          class="inline-block sm:block sm:mb-2 font-light text-60 lg:text-4xl text-black-dark leading-tight mr-2"
        >
          <span class="inline-block">Not Found</span>
          <span class="code-label">Error code 404</span>
        </h1>
        <div class="mt-3">2025-12-10 03:50:29 UTC</div>
      </header>
        ...
        <div class="w-240 lg:w-full mx-auto">
          <div class="clearfix md:px-8">
            ...
            >
              ...
              <span class="md:block w-full truncate">404</span>
              <h3
                class="md:inline-block mt-3 md:mt-0 text-2xl text-gray-600 font-light leading-1.3"
              >
                Website
              </h3>
              <span class="leading-1.3 text-2xl" style="color: #bd2426">Not Found</span>
            </div>
            <div
            ...
            >
              ...
              <span class="md:block w-full truncate">Somewhere</span>
              <h3
                class="md:inline-block mt-3 md:mt-0 text-2xl text-gray-600 font-light leading-1.3"
              >
                Cloud
      ...
      <div class="w-240 lg:w-full mx-auto mb-8 lg:px-8">
        <div class="clearfix">
          <div class="w-1/2 md:w-full float-left pr-6 md:pb-10 md:pr-0 leading-relaxed">
            ...
            The URL you wanna go to is missing.
          </div>
      ...
      >
        <p class="text-13">
          <span class="cf-footer-item sm:block sm:mb-1"
            >Ray ID: <strong class="font-semibold">114514</strong></span
          >
...
.bg-gradient-gray {
  background-image: linear-gradient(to bottom, #dedede 0%, #ebebeb 3%, #ebebeb 97%, #dedede 100%);
}
...
.cf-error-source:after {
  ...
  -webkit-transform: translateX(var(--transform-translate-x))
    ...
    skewX(var(--transform-skew-x)) skewY(var(--transform-skew-y)) scaleX(var(--transform-scale-x))
    scaleY(var(--transform-scale-y));
  -ms-transform: translateX(var(--transform-translate-x)) translateY(var(--transform-translate-y))
